...
- [x] **Step 3: Implement the minimal Edge Function**
...
- [x] **Step 1: Extend failing tests for frontend wiring**
...
- [x] **Step 3: Implement module and styles**
...
- [x] **Step 2: Verify database invariants without contaminating production data**
...
- [x] **Step 3: Deploy `getlink-orders` with `verify_jwt=false`**
...
- [x] **Step 4: Smoke-test auth boundaries**

Verified unauthenticated access, missing/invalid customer session, invalid Admin token are rejected, and CORS preflight succeeds. No production order was created during smoke testing.

- [x] **Step 5: Re-run verification after any fix and report exact commit/run ids**

Final branch verification is GREEN before integration.
