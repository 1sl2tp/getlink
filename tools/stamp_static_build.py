...
def calculate():
    ...
    payload={
        ...
        'assets':['index.html','style.css','config.js','app.js','order-management.js','order-management.css','taphoa-workspace-feedback.js','taphoa-workspace-feedback.css','taphoa-order-workspace-v2.css'],
    }
