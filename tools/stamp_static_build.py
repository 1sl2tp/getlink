...
def calculate():
    ...
    payload={
        ...
        'assets':['index.html','style.css','config.js','app.js','order-management.js','order-management.css','taphoa-mobile-standard.js','taphoa-mobile-standard.css','taphoa-desktop-workspace.js','taphoa-desktop-workspace.css','taphoa-desktop-data.js','taphoa-desktop-sales.js','taphoa-desktop-orders.js','taphoa-desktop-debts.js','taphoa-workspace-feedback.js','taphoa-workspace-feedback.css','taphoa-order-workspace-v2.css','taphoa-hot-path-runtime.js','taphoa-hot-path-runtime.css'],
    }
